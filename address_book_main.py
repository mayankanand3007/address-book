...
def main():
    while True:
        ...
        operation_number = int(input("Enter the above number(1-8) to do the following operation: "))
        switcher = {
        ...
        # Checks if input given by the user is between 1 and 8 else asks the input again.
