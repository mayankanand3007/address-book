"""
    ...
    @Title : Testing ability to Sort Contacts by Zip Code in Address Book Program
"""
...
class TestSortedContactsZip(ut.TestCase):
    def test_sorted_zip(self):
        # Checking correct input.
        self.assertEqual(contact_instance.view_sorted_contacts_zip(), 
        ...
        self.assertNotEqual(contact_instance.view_sorted_contacts_zip(), 
        [{'f_name': '11', 'l_name': 'Anand','address': 'B8, Acharya Niketan', 'city': 'Mayur Vihar', 
        'state': 'Delhi', 'zip': 110091, 'phone_no': 9560291169, 'email': 'mayankan@gmail.com'},
        {'f_name': 'Mayank', 'l_name': 'Anand','address': 'B8, Acharya Niketan', 'city': 'Mayur Vihar Phase 1', 
        'state': 'Delhi', 'zip': 110091, 'phone_no': 9560291169, 'email': 'mayankan@gmail.com'}])
